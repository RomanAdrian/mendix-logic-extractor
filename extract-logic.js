...
import { projects, domainmodels, microflows, security, datatypes, texts } from "mendixmodelsdk";
 ...
 */
async function extractModuleSecurity(module) {
 ...
 */
function extractAttributeType(type) {
 ...
 */
function extractAttributeTypeFromAttr(type) {
 ...
 */
function extractValueType(value) {
    if (!value)
        return null;
 ...
 */
function extractParameters(microflow) {
    const parameters = [];
 ...
 */
function extractActivities(microflow) {
    const activities = [];
    for (const obj of microflow.objectCollection.objects) {
 ...
 */
function extractActionActivity(activity) {
 ...
 */
function extractSplitCondition(condition) {
    if (!condition)
        return null;
...
function extractFlows(microflow) {
 ...
 */
function extractCaseValues(caseValues) {
 ...
 */
function extractSingleCaseValue(caseValue) {
